...
export const defaultAssets: Asset[] = [
  ...
  },
  {
    ...
    systemPrompt:
      "You are a helpful AI assistant ready to assist with any task. Provide clear, accurate, and helpful responses tailored to the user's needs.",
    personality: {
  ...
  },
  {
    ...
    systemPrompt:
      'You are the Persona Summoner. You can analyze situations, intents, and automatically select or create the perfect persona for any context. You understand how to blend personalities and capabilities.',
    personality: {
